...
public $vista = "cruds.crud-appointments-";
public $ruta = "appointments";
...
[ 'client_id'  => $request->client_id ,'date'  => $request->date ,'time'  => $request->time ,'status'  => $request->status ,'note'  => $request->note ,'members'  => $request->members ,'color'  => $request->color ,'order_position'  => $request->order_position  ] 
       );
