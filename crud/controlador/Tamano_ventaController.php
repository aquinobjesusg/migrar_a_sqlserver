...
class Tamano_ventaController extends Controller
{
public $tabla = "tamano_venta";
public $vista = "cruds.crud-tamano_venta-";
public $ruta = "tamano_venta";
