...
{
public $tabla = "categories";
public $vista = "cruds.crud-categories-";
public $ruta = "categories";
...
[ 'id'  => $id ,'name'  => $request->name ,'sucursal_id'  => $request->sucursal_id  ] 
       );
...
[ 'name'  => $request->name ,'sucursal_id'  => $request->sucursal_id  ] 
       );
