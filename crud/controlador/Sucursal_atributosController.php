...
public $vista = "cruds.crud-sucursal_atributos-";
public $ruta = "sucursal_atributos";
...
[ 'sucursal_id'  => $request->sucursal_id ,'logo_principal'  => $request->logo_principal ,'imagen_1'  => $request->imagen_1 ,'imagen_2'  => $request->imagen_2 ,'imagen_3'  => $request->imagen_3 ,'imagen_4'  => $request->imagen_4 ,'imagen_5'  => $request->imagen_5 ,'color_1'  => $request->color_1 ,'color_2'  => $request->color_2 ,'color_3'  => $request->color_3 ,'color_4'  => $request->color_4 ,'color_5'  => $request->color_5 ,'baner_1'  => $request->baner_1 ,'baner_2'  => $request->baner_2 ,'baner_3'  => $request->baner_3 ,'baner_4'  => $request->baner_4 ,'baner_5'  => $request->baner_5 , ] 
       );
