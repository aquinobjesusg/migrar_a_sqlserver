...
{
public $tabla = "direcciones";
public $vista = "cruds.crud-direcciones-";
public $ruta = "direcciones";
...
[ 'id'  => $id ,'titulo'  => $request->titulo ,'direccion'  => $request->direccion ,'user_id'  => $request->user_id  ] 
       );
...
[ 'titulo'  => $request->titulo ,'direccion'  => $request->direccion ,'user_id'  => $request->user_id  ] 
       );
