...
use App\Modelo\Agente_recaudacion;
...
class Agente_recaudacionController extends Controller
{
public $tabla = "agente_recaudacion";
public $vista = "cruds.crud-agente_recaudacion-";
public $ruta = "agente_recaudacion";
