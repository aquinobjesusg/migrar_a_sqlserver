...
use App\Modelo\Products_componentes;
...
public $vista = "cruds.crud-products_componentes-";
public $ruta = "products_componentes";
...
[ 'orden'  => $request->orden ,'name_component'  => $request->name_component ,'produt_id'  => $request->produt_id  ] 
       );
