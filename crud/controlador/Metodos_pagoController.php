...
public $vista = "cruds.crud-metodos_pago-";
public $ruta = "metodos_pago";
...
[ 'titulo'  => $request->titulo ,'icono'  => $request->icono ,'user_id'  => $request->user_id ,'sucursal_id'  => $request->sucursal_id ,'afiliado_id'  => $request->afiliado_id ,'delivery_id'  => $request->delivery_id ,'empresa_id'  => $request->empresa_id  ] 
       );
