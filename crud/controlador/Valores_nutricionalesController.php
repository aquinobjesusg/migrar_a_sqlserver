...
use App\Modelo\Valores_nutricionales;
...
public $vista = "cruds.crud-valores_nutricionales-";
public $ruta = "valores_nutricionales";
...
[ 'name'  => $request->name ,'valor'  => $request->valor ,'activo'  => $request->activo ,'sucursal_id'  => $request->sucursal_id  ] 
       );
