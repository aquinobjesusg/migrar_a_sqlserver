...
{
public $tabla = "sub_categories";
public $vista = "cruds.crud-sub_categories-";
public $ruta = "sub_categories";
...
[ 'id'  => $id ,'name'  => $request->name ,'categoria_id'  => $request->categoria_id  ] 
       );
...
[ 'name'  => $request->name ,'categoria_id'  => $request->categoria_id  ] 
       );
