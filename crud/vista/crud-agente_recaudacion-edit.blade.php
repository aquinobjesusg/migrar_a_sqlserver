...
@lang('dicc.EditarAgente_recaudacion')
</h5>
<div class="card-body">
<p class="card-text">
<form method="POST" action="{{ route('agente_recaudacion.update',$registro->id) }}">
@csrf
@method('PUT')
...
<a href="{{ route('agente_recaudacion.index') }}" class="btn btn-defaultchar" >
