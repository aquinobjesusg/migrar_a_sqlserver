...
class PvademeController extends Controller
{
...
[ 'codmedi'  => $request->codmedi ,'nombrege'  => $request->nombrege ,'nombreco'  => $request->nombreco ,'dosifi'  => $request->dosifi ,'uso'  => $request->uso ,'presenta'  => $request->presenta , ] 
        );
