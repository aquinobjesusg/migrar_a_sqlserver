...
class PanteceController extends Controller
{
...
[ 'nhisto'  => $request->nhisto ,'codante'  => $request->codante ,'detalle'  => $request->detalle ,'tipo'  => $request->tipo ,'descrip'  => $request->descrip ,'consul'  => $request->consul , ] 
        );
