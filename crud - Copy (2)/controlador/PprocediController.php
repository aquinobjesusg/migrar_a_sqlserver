...
class PprocediController extends Controller
{
...
[ 'nhisto'  => $request->nhisto ,'nconsul'  => $request->nconsul ,'procedi1'  => $request->procedi1 ,'procedi2'  => $request->procedi2 ,'procedi3'  => $request->procedi3 , ] 
        );
