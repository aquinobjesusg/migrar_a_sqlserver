...
[ 'fecha'  => $request->fecha ,'numhistoria'  => $request->numhistoria ,'numorden'  => $request->numorden ,'atendido'  => $request->atendido ,'estado'  => $request->estado ,'turno'  => $request->turno ,'motivo'  => $request->motivo ,'monto'  => $request->monto ,'hora_ini'  => $request->hora_ini ,'hora_fin'  => $request->hora_fin ,'tiempo'  => $request->tiempo ,'tipo'  => $request->tipo ,'conse'  => $request->conse ,'sms'  => $request->sms ,'sms_text'  => $request->sms_text ,'medico'  => $request->medico , ] 
        );
