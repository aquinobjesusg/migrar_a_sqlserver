...
@lang('dicc.Reg_empl_frec_nomina')
    ...
    <table id="example" class="display" style="width:100%">
        <thead>
<tr><th>@lang('dicc.NameOfId')</th><th>@lang('dicc.NameOfFrecuencia_nomina')</th><th>@lang('dicc.NameOfNombre_frecuencia')</th><th>@lang('dicc.Opciones')</th><th></th></tr>
        </thead>
        <tbody>
            @foreach ($registros as $registro)
                <tr>
<td>{{ $registro->id }}</td><td>{{ $registro->frecuencia_nomina }}</td><td>{{ $registro->nombre_frecuencia }}</td>
                    <td>
                    @if( $btn_ver == 1 )
